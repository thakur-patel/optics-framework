...
# tool needed. Kept as a standalone file (not a Python string literal) so it
# reads and edits like the doc it is.
_PROJECT_FORMAT_DOC = (
    pathlib.Path(__file__).parent / "mcp_project_format.md"
