...
class FlowControl:
    ...
    def _evaluate_conditions(
        ...
        if else_target is not None:
            internal_logger.debug(f"[_EVALUATE_CONDITIONS] No condition met. Executing ELSE block module '{else_target}'.")
    ...
    def _extract_from_json(self, data: Any, path: str) -> Optional[Any]:
        """Extracts a value using a JSONPath expression, or the bare ``a.b`` form."""
